...
public class QScore extends EntityPathBase<Score> {
    ...
    private static final long serialVersionUID = -1987976382L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QScore score = new QScore("score");

    public final NumberPath<Double> aiScore = createNumber("aiScore", Double.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final NumberPath<Double> lcScore = createNumber("lcScore", Double.class);

    public final QMember member;

    public final NumberPath<Double> mwScore = createNumber("mwScore", Double.class);

    public final NumberPath<Double> pbScore = createNumber("pbScore", Double.class);
